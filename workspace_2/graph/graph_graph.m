...
for m = 1:length(met_n)
    data = {alg_n{1}, round(mean(dat_n{1*m}), 2), round(median(dat_n{1*m}), 2); ...
            alg_n{2}, round(mean(dat_n{2*m}), 2), round(median(dat_n{2*m}), 2); ...
            alg_n{3}, round(mean(dat_n{3*m}), 2), round(median(dat_n{3*m}), 2); ...
            alg_n{4}, round(mean(dat_n{4*m}), 2), round(median(dat_n{4*m}), 2); ...
            alg_n{5}, round(mean(dat_n{5*m}), 2), round(median(dat_n{5*m}), 2); ...
    }
